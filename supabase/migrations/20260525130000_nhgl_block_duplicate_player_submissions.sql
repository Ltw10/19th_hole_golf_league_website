-- Block player-facing resubmits; scores for an existing week/match slot must be edited via admin.
...
BEGIN
  ...
  VALUES (
    ...
    GREATEST(0, nhgl._handicap_for_strokes(p_player_id, v_week_date))
  )
